...
export default function Home() {
  ...
  return (
    ...
    <motion.div ref={DivRef} variants={{hidden:{opacity:0,translateX:25},visible:{opacity:1,translate:0}}} initial='hidden' transition={{ delay:0.25, ease: "easeInOut", duration:0.5}} animate={control} className='absolute left-[0] top-[0] z-40 h-[100%] w-[100%] overflow-hidden'>
    <main className={styles.main}>
      ...
      >
          <p onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}} id='para'>
      ...
      <div className={styles.body}>
        <p id='para'>At <span id='span'>Harmony, </span> we offer practical solutions to mental health challenges through our expert team. Operating remotely, we connect individuals with top mental health professionals, ensuring personalized care. Our commitment is to empower you with resources and support for a healthier, balanced life. Discover a harmonious journey to mental well-being with us</p>
      </div>
